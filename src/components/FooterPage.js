  ...
  return (
    <footer className="py-10 px-6 md:px-16 bg-white text-black font-Inter">
      ...
      <div className="grid grid-cols-3  text-center md:grid-cols-3 gap-8 w-full md:max-w-full">
        <div>
          <h3 className="footer-heading font-semibold text-lg mb-2">Services</h3>
        ...
        <div>
          <h3 className="footer-heading font-semibold text-lg mb-2">Company</h3>
          <ul className="space-y-2">
        ...
        <div>
          <h3 className="footer-heading font-semibold text-lg mb-2">Resources</h3>
          <ul className="space-y-2">
